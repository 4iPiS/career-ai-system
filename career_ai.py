#!/usr/bin/env python3
"""
УМНАЯ СИСТЕМА ВЫБОРА НАПРАВЛЕНИЯ ОБУЧЕНИЯ - РЕАЛЬНАЯ ВЕРСИЯ
"""
...
class CareerAdvisorAI:
    """Искусственный интеллект для рекомендации направлений"""
    ...
    def analyze_student_profile(self, csv_path):
        """Анализ профиля студента из CSV"""
    ...
    def _prepare_student_data(self, student_df):
        """Подготовка данных студента для нейросети"""
        expected_features = [
...
class CareerAdvisorInterface:
    """Красивый интерфейс для вывода результатов"""
    ...
    def print_all_recommendations(self, recommendations, student_data, csv_path):
        ...
        # ИЗМЕНИТЕ: показывайте все рекомендации (не только 3)
        ...
        # ДОБАВЬТЕ ТАБЛИЦУ СО ВСЕМИ 5 РЕКОМЕНДАЦИЯМИ:
        print("\n" + "="*80)
...
def create_template_csv():
    """Создание шаблона CSV для тестирования"""
    print("\n" + "="*80)
